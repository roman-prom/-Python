...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage(file='./Module 4/ввыы/img/add.png')
        ...
        self.edit_img = tk.PhotoImage(file='./Module 4/ввыы/img/update.png')
        ...
        self.del_img = tk.PhotoImage(file='./Module 4/ввыы/img/delete.png')
        ...
        self.search_img = tk.PhotoImage(file='./Module 4/ввыы/img/search.png')
        ...
        self.refresh_img = tk.PhotoImage(file='./Module 4/ввыы/img/refresh.png')
    ...
    def edit_record(self, name, tel, email):
        ...
        self.db.cur.execute('''
            UPDATE сотрудники SET name = ?, phone = ?, email = ?
            WHERE id = ?
        ''', (name, tel, email, ind))
        self.db.conn.commit()
        self.view_records()
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.entry_tel.place(x=150, y=75)
        self.entry_email = tk.Entry(self)
        self.entry_email.place(x=150, y=100)
...
class Db:
    ...
    def insert_data(self, name, tel, email):
        self.cur.execute('''
                INSERT INTO сотрудники (name, phone, email)
